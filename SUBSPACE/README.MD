...
<p align="center">
  <img height="200" height="auto" src="https://user-images.githubusercontent.com/50621007/171398816-7e0432f4-4d39-42ad-a72e-cd8dd008028f.png">
</p>
...
```bash
wget -O subspace.sh https://raw.githubusercontent.com/Agus1224/NODE_TESTNET/main/SUBSPACE/subspace.sh && chmod +x subspace.sh && ./subspace.sh
```
