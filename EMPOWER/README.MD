...
# Empower testnet node setup — circulus-1
...
### Option 2 (manual)
You can follow [manual guide](https://github.com/Alfonova-Node/NODE_TESTNET/blob/main/EMPOWER/manual_install.md) if you better prefer setting up node manually
