...
cd $HOME
wget https://github.com/massalabs/massa/releases/download/TEST.19.2/massa_TEST.19.1_release_linux.tar.gz
...
wget https://raw.githubusercontent.com/Alfonova-Node/NODE_TESTNET/main/MASSA%20LABS/config.toml
