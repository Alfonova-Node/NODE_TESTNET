...
sudo systemctl stop dbonus-blockd
...
```
```
curl -L https://snapshot.bonusblock.alfonova.app/bonusblock/bonusblock-snapshot-20230319.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.bonusblock
